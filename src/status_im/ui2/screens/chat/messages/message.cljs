...
(defn message-content-wrapper
  ...
  [{:keys [last-in-group? identicon from in-popover? timestamp-str deleted?
           deleted-for-me? deleted-undoable-till deleted-for-me-undoable-till
           pinned]
