(ns quo2.components.tags.scrollable-view
...
(defn view
  ...
  (let [active-tab-id (reagent/atom default-active)
    ...
    (fn [{:keys [data fade-end-percentage fade-end? on-change on-scroll
                 scroll-event-throttle scroll-on-press? size type labelled?
                 disabled? blurred? icon-color blur? component
                 override-theme]
          :or   {fade-end-percentage fade-end-percentage fade-end? false
                 scroll-event-throttle 64 scroll-on-press? false size
                 default-tab-size}
          :as   props}]
